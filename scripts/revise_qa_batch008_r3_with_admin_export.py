...
BATCH_ID = "qa_batch_008_r3"
QA_RUN_ID = "20260907_173014"

SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "revisions" / "qa_batch_008_r2" / "SEO_Product_Optimization_qa_batch_008_r2.xlsx"
...
OUTPUT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_008_r3.xlsx"
REPORT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_008_r3.md"
...
def customizer_sentence(audit):
    ...
    for node in nodes:
        ...
        if min_length and limit:
            parts.append(f"Personalization uses a {required} {label} field, {min_length}-{limit} characters.")
        elif limit:
...
def main():
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["mapping_reason"]).value = "R3 separates pages by visible motif and verified Customizer capability."
    ...
    for metric, value, definition in [
        ("qa_batch_008_r3_revision", "r3", "Separate 10-product revision after Sang QA; source workbook was not modified."),
        ("qa_batch_008_r3_admin_export", str(ADMIN_EXPORT.relative_to(ROOT)), f"Admin CSV baseline used; sha256:{admin_hash}."),
        ("qa_batch_008_r3_scope", "inventory positions 71-80", "No products outside qa_batch_008 were revised."),
        ("qa_batch_008_r3_revised_products", str(revised_products), "SEO_Products rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_008_r3_revised_images", str(revised_images), "Image_Audit rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_008_r3_admin_alt_matches", str(admin_alt_matches), "Image rows with current admin alt matched by image URL from Shopify CSV."),
    ]:
        ws.append([
    ...
    summary = {
        ...
        "next_step": "Sang QA qa_batch_008_r3 before any approval or import.",
    }
    SUMMARY.write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    REPORT.write_text(
        "\n".join(
            [
                "# Revision qa_batch_008_r3",
                "",
                ...
                "- Bước tiếp theo: Sang QA lại `qa_batch_008_r3`.",
                "",
            ]
        ),
        encoding="utf-8",
