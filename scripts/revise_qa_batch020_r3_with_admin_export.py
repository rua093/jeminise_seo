...
BATCH_ID = "qa_batch_020_r3"
QA_RUN_ID = "20260907_214100"

SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "revisions" / "qa_batch_020_r2" / "SEO_Product_Optimization_qa_batch_020_r2.xlsx"
...
OUTPUT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_020_r3.xlsx"
REPORT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_020_r3.md"
...
PRODUCT_UPDATES = {
    191: {
        ...
        "meta_description": "Shop custom red black baseball batter bedding with player silhouette, required name field and size panel.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by red-black batter silhouette artwork; visible numbers are sample artwork only.",
    },
    192: {
        "title": "Custom Brown Baseball Glove Bedding",
        "meta_title": "Custom Brown Baseball Glove Bedding",
        "meta_description": "Shop custom brown baseball glove bedding with close-up ball artwork, required name field and size panel.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by brown glove close-up artwork.",
    },
    193: {
        "title": "Custom Flaming Baseball Batter Bedding",
        "meta_title": "Custom Flaming Baseball Batter Bedding",
        "meta_description": "Shop custom flaming baseball batter bedding with fire ring artwork, required name field and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by flaming ball-and-batter artwork; visible numbers are sample artwork only.",
    },
    194: {
        "title": "Custom Orange Fire Baseball Bedding",
        "meta_title": "Custom Orange Fire Baseball Bedding",
        "meta_description": "Shop custom orange fire baseball bedding with batter artwork, required name field and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by orange fire player scene; visible numbers are sample artwork only.",
    },
    195: {
        "title": "Custom Baseball Glove Flag Bedding",
        "meta_title": "Custom Baseball Glove Flag Bedding",
        "meta_description": "Shop custom baseball glove flag bedding with American flag artwork, required name field and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by glove over flag layout; visible numbers are sample artwork only.",
    },
    196: {
        "title": "Custom Black Baseball Glove Bedding",
        "meta_title": "Custom Black Baseball Glove Bedding",
        "meta_description": "Shop custom black baseball glove bedding with monochrome glove artwork, required name field and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by black monochrome glove artwork; visible numbers are sample artwork only.",
    },
    197: {
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by lightning storm baseball artwork; visible numbers are sample artwork only.",
    },
    198: {
        "title": "Custom Night Field Baseball Bedding",
        "meta_title": "Custom Night Field Baseball Bedding",
        "meta_description": "Shop custom night field baseball bedding with helmet, glove and ball artwork plus a required name field.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by night field equipment scene.",
    },
    199: {
        "title": "Custom Smoke Baseball Batter Bedding",
        "meta_title": "Custom Smoke Baseball Batter Bedding",
        "meta_description": "Shop custom smoke baseball batter bedding with dark player silhouette, required name field and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by smoky black batter scene; visible numbers are sample artwork only.",
    },
    200: {
        "title": "Custom Baseball Stitch Name Bedding",
        "meta_title": "Custom Baseball Stitch Name Bedding",
        "meta_description": "Shop custom baseball stitch bedding with close-up laces, required name field, sample number artwork and feature panels.",
        ...
        "intent_role": "Baseball bedding page supported by a required name field and separated by close-up red stitching artwork; visible numbers are sample artwork only.",
    },
}
...
def main():
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["issues"]).value = (
            f"R3 deep recheck after Sang QA batch 020: used products_export_1.csv sha256:{admin_hash}; "
            "removed internal workflow copy, filled publishable title values, kept custom name claims because customizer audit verifies them, "
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["jtbd_statement"]).value = (
            ...
            "and the required custom name field before purchase."
        )
    ...
    for metric, value, definition in [
        ("qa_batch_020_r3_revision", "r3", "Separate 10-product revision after Sang QA; source workbook was not modified."),
        ("qa_batch_020_r3_admin_export", str(ADMIN_EXPORT.relative_to(ROOT)), f"Admin CSV baseline used; sha256:{admin_hash}."),
        ("qa_batch_020_r3_scope", "inventory positions 191-200", "No products outside qa_batch_020 were revised."),
        ("qa_batch_020_r3_revised_products", str(revised_products), "SEO_Products rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_020_r3_revised_images", str(revised_images), "Image_Audit rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_020_r3_admin_alt_matches", str(admin_alt_matches), "Image rows with current admin alt matched by image URL from Shopify CSV."),
    ]:
        ws.append([
    ...
    summary = {
        ...
        "next_step": "Ready to hand off latest revisions through qa_batch_020_r3 for QA, per user request.",
    }
    SUMMARY.write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    REPORT.write_text(
        "\n".join(
            [
                "# Revision qa_batch_020_r3",
                "",
                ...
                "- Bước tiếp theo: có thể gửi Sang QA lại nhóm revision mới nhất đến `qa_batch_020_r3`, theo yêu cầu người dùng.",
                "",
            ]
        ),
        encoding="utf-8",
