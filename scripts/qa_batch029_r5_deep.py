...
QA_RUN_ID = "20260909_151928"
BATCH_ID = "qa_batch_029_r5"
SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "revisions" / "qa_batch_029_r5" / "SEO_Product_Optimization_qa_batch_029_r5.xlsx"
...
def main():
    ...
    for p in products:
        ...
        if p.get("revision") not in {"r4", "r5"}:
            ...
            issues.append({
                ...
                "source_observation": "Source workbook path is qa_batch_029_r5 but row-level revision remains from an older substantive revision.",
    ...
    xlsx = OUT_DIR / "SEO_QA_qa_batch_029_r5.xlsx"
    md = OUT_DIR / "SEO_QA_qa_batch_029_r5.md"
    ...
    md.write_text(f"""# SEO QA qa_batch_029_r5
