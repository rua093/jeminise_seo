...
BATCH_ID = "qa_batch_016_r2"
QA_RUN_ID = "20260907_210204"

SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "batches" / "SEO_Product_Optimization_through_batch_016.xlsx"
...
OUTPUT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_016_r2.xlsx"
REPORT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_016_r2.md"
...
PRODUCT_UPDATES = {
    ...
    153: {
        "title": "Yellow Horse Patchwork Quilt",
        "meta_title": "Yellow Horse Patchwork Quilt",
        ...
        "primary": "yellow horse patchwork quilt",
        "secondary": "colorful horse quilt, farmhouse horse bedding, animal patchwork quilt",
        "cluster": "yellow colorful horse portrait patchwork quilt",
    ...
    157: {
        "title": "Stained Glass Tree Landscape Quilt",
        "meta_title": "Stained Glass Tree Landscape Quilt",
        ...
        "primary": "stained glass tree landscape quilt",
    ...
    159: {
        "title": "Norse Ravens Runic Quilt Set",
        "meta_title": "Norse Ravens Runic Quilt Set",
        ...
        "primary": "Norse ravens runic quilt set",
...
def main():
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["issues"]).value = (
            f"R2 after Sang QA batch 016: used products_export_1.csv sha256:{admin_hash}; "
            "removed internal workflow copy, filled publishable H1/title values, avoided unsupported customization/photo claims, "
            "split animal/tree/Norse intents by visible motif, and rewrote image observations/alts from inspected contact sheets. "
            "Still NEEDS_REVIEW."
        )
        revised_products += 1
    ...
    for metric, value, definition in [
        ("qa_batch_016_r2_revision", "r2", "Separate 10-product revision after Sang QA; source workbook was not modified."),
        ("qa_batch_016_r2_admin_export", str(ADMIN_EXPORT.relative_to(ROOT)), f"Admin CSV baseline used; sha256:{admin_hash}."),
        ("qa_batch_016_r2_scope", "inventory positions 151-160", "No products outside qa_batch_016 were revised."),
        ("qa_batch_016_r2_revised_products", str(revised_products), "SEO_Products rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_016_r2_revised_images", str(revised_images), "Image_Audit rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_016_r2_admin_alt_matches", str(admin_alt_matches), "Image rows with current admin alt matched by image URL from Shopify CSV."),
    ]:
        ws.append([
    ...
    REPORT.write_text(
        "\n".join(
            [
                ...
                "- Sửa trọng yếu: bỏ nội dung nội bộ, bổ sung title/H1 publishable, tránh claim custom/photo không có bằng chứng, tách intent cho animal/tree/Norse/Christian và viết lại mô tả/alt theo contact sheets.",
