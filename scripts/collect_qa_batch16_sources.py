...
ROOT = module.ROOT
RUN_ID = "20260907_210204"
QA = ROOT / "seo_runs/jeminise.com/20260906_234129/qa" / RUN_ID
WORKBOOK = ROOT / "resutls/jeminise.com/20260906_234129/batches/SEO_Product_Optimization_through_batch_016.xlsx"
...
def main():
    ...
    rows = list(module.csv.DictReader((ROOT / "seo_runs/jeminise.com/20260906_234129/inventory.csv").open(encoding="utf-8-sig")))[150:160]
    ...
    for row in rows:
        try:
            record = {"inventory": row, "live": module.m.fetch_live(row["product_url"]), "fetch_error": ""}
        except Exception as exc:
            record = {"inventory": row, "live": {}, "fetch_error": str(exc)}
        live.append(record)
