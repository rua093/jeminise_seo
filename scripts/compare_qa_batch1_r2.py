...
REVISION = ROOT / "resutls" / "jeminise.com" / "20260906_234129" / "revisions" / "qa_batch_001_r2" / "SEO_Product_Optimization_qa_batch_001_r2.xlsx"
OUTPUT = RUN / "qa" / "20260907_114114" / "revision_diff.json"
        ...
        for rid in sorted(set(before) | set(after)):
            ...
            for field in sorted(set(old) | set(new)):
                if old.get(field) != new.get(field):
                    fields.append({"field": field, "before": old.get(field), "after": new.get(field)})
            if fields:
