...
PREVIOUS = BATCHES_DIR / "SEO_Product_Optimization_through_batch_015.xlsx"
OUTPUT = BATCHES_DIR / "SEO_Product_Optimization_through_batch_016.xlsx"


GIRAFFE_REFS = "https://www.walmart.com/c/kp/giraffe-quilt; https://www.etsy.com/; https://www.pinterest.com/ideas/giraffe-quilt-patterns/954859962493/"
HORSE_REFS = "https://www.amazon.com/horse-quilt/s?k=horse+quilt; https://www.etsy.com/market/horse_quilt; https://www.pinterest.com/search/pins/?q=horse%20patchwork%20quilt"
SCRIPTURE_REFS = "https://christianartbag.com/products/christianart-blanket-god-says-i-am-christian-blanket-bible-verse-blanket-personalized-blanket-christmas-gift-cabbk01111123; https://www.amazon.com/Christian-Personalized-Customized-Inspirational-Religious/dp/B0DRXF6LWM; https://www.etsy.com/uk/listing/4410818176/christian-name-blanket-god-says-i-am; https://www.pinterest.com/ideas/bible-verse-blanket/910177925520/"
TREE_REFS = "https://www.amazon.com/clp/B0D9NXRP1Q; https://alphaquilt.com/products/tai111124134; https://www.google.com/m/storepages?c=IN&hl=en-IN&q=etsy.com; https://www.internationalquiltmuseum.org/about/quilt-month/tree-life-0"
NORSE_REFS = "https://www.amazon.com/WDBAYXH-Mythology-Valhalla-Pillowcase-Microfiber/dp/B09XXVKX8C; https://vikingsonsofodin.com/product/viking-bedding-set-viking-raven-skull-norse-mjolnir-viking-bed-set/; https://uk.worldnorse.com/products/worldnorse-celtic-knot-mjolnir-bedding-set; https://myvikinggear.com/collections/viking-home-decoration/viking-quilt-set/"


PROFILES = {
    151: ("blue mosaic giraffe patchwork quilt", "giraffe patchwork quilt", "Giraffe Patchwork Quilt Set", "Blue Mosaic Giraffe Patchwork Quilt", "large giraffe portrait in blue, teal, orange and tan mosaic patchwork styling with matching shams", "giraffe bedding, animal patchwork quilt, safari animal quilt set", "EVERGREEN", GIRAFFE_REFS),
    152: ("vintage horse patchwork quilt with warm sunset colors", "vintage horse quilt", "Vintage Horse Quilt Set", "Vintage Horse Patchwork Quilt Set", "horse portrait inside a circular warm orange, gold and black stained-glass style frame", "horse bedding, horse patchwork quilt, equestrian quilt set", "EVERGREEN", HORSE_REFS),
    153: ("yellow farmhouse horse patchwork quilt", "yellow horse quilt", "Yellow Horse Quilt Set", "Yellow Farmhouse Horse Patchwork Quilt", "colorful horse head portrait on a yellow farmhouse-style background with black border and matching shams", "horse bedding, animal farmhouse quilt, patchwork horse quilt", "EVERGREEN", HORSE_REFS),
    154: ("I Am Who He Says I Am Christian scripture blanket", "Christian scripture blanket", "Christian Scripture Blanket", "I Am Who He Says I Am Scripture Blanket", "white blanket with green, gold and gray Christian affirmation text and Bible verse references", "Bible verse blanket, inspirational Christian blanket, God says I am blanket", "EVERGREEN", SCRIPTURE_REFS),
    155: ("cream twisted Tree of Life quilt", "twisted tree of life quilt", "Twisted Tree of Life Quilt Set", "Cream Twisted Tree of Life Quilt", "cream quilt with twisting brown Tree of Life trunk, exposed roots and green leaves", "tree of life bedding, nature tree quilt, botanical quilt set", "EVERGREEN", TREE_REFS),
    156: ("black blooming Tree of Life floral quilt", "blooming tree of life quilt", "Blooming Tree of Life Quilt Set", "Black Blooming Tree of Life Quilt", "blooming Tree of Life with exposed roots, white flowers and floral border on a black background", "tree of life bedding, floral tree quilt, nature quilt set", "EVERGREEN", TREE_REFS),
    157: ("stained glass Tree of Life landscape quilt", "stained glass tree of life quilt", "Stained Glass Tree of Life Quilt", "Stained Glass Tree of Life Landscape Quilt", "Tree of Life inside a stained-glass oval with sunset sky, green landscape and multicolor border", "tree of life bedding, stained glass quilt, nature landscape quilt", "EVERGREEN", TREE_REFS),
    158: ("Norse Mjolnir skull Celtic quilt", "Mjolnir skull quilt", "Mjolnir Skull Quilt Set", "Norse Mjolnir Skull Celtic Quilt", "black and gray Norse mythology quilt with Mjolnir, skull, Celtic knotwork and raven border", "Norse bedding, Viking quilt set, Thor hammer quilt", "EVERGREEN", NORSE_REFS),
    159: ("Norse raven runic symbol quilt", "Norse raven quilt", "Norse Raven Quilt Set", "Norse Raven Runic Symbol Quilt", "beige and black Norse mythology quilt with two ravens, runic symbols, compass motifs and tree detail", "Viking raven bedding, Norse mythology quilt, runic quilt set", "EVERGREEN", NORSE_REFS),
    160: ("pink Norse raven runic circle comforter", "raven runic circle comforter", "Raven Runic Circle Comforter", "Pink Norse Raven Runic Circle Comforter", "dark navy comforter with pink runic circle, raven emblem and Celtic knot detail", "Norse raven bedding, Viking comforter, runic circle bedding", "EVERGREEN", NORSE_REFS),
}
...
def main():
    ...
    for summary in summaries:
        ...
        if pos in (152, 153):
            issue_bits.append("Horse patchwork variants are close; keep palette and background differences explicit to reduce cannibalization.")
        if pos == 154:
            issue_bits.append("Visible Scripture references and personalization/changeable text should be proofread before import.")
        if pos in (155, 156, 157):
            issue_bits.append("Tree of Life variants overlap with prior batches; review keyword map, title uniqueness and canonical strategy.")
        if pos in (158, 159, 160):
            issue_bits.append("Norse mythology products are closely related; differentiate by Mjolnir/skull/raven/runic-circle motifs.")
        if html_error:
        ...
        desc = (
            f"<p>This Jeminise {kind} features {detail}, making it suited for animal rooms, faith gifts, nature-inspired decor or Viking-themed bedrooms.</p>"
        ...
        append_dict(wb["Buyer_Search_Research"], {
            ...
            "jtbd_statement": f"When shopping for themed bedding, the buyer wants a {kind} matching a specific animal, faith, Tree of Life or Norse mythology motif.",
            "functional_motivation": "Find the right design, size, bedding type, care details and decor fit.",
            "emotional_social_motivation": "Create a distinctive bedroom look or give a themed animal, faith, nature or Viking-inspired gift.",
            "purchase_concerns": "Product identity, personalization spelling, material/care claims, design distinction and whether the visible artwork matches expectations.",
        ...
        for image in images:
            ...
            alt = {
                ...
                4: f"Feature, fabric or lifestyle image for {h1}",
    ...
    for row in [
        {"metric": "batch_016_products", "value": "10", "definition": "Products appended in this cumulative workbook"},
        {"metric": "batch_016_images", "value": str(added_images), "definition": "Gallery images downloaded and viewed for batch_016"},
        {"metric": "cumulative_products", "value": "160", "definition": "Total products included through batch_016"},
    ]:
