...
QA_RUN_ID = "20260909_142635"
BATCH_ID = "qa_batch_030_r4"
SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "revisions" / "qa_batch_030_r4" / "SEO_Product_Optimization_qa_batch_030_r4.xlsx"
...
def main():
    ...
    for p in products:
        ...
        if p.get("revision") != "r4":
            ...
            issues.append({
                ...
                "source_observation": "Source workbook path is qa_batch_030_r4 but row-level revision remains r2.",
    ...
    xlsx = OUT_DIR / "SEO_QA_qa_batch_030_r4.xlsx"
    md = OUT_DIR / "SEO_QA_qa_batch_030_r4.md"
    ...
    md.write_text(f"""# SEO QA qa_batch_030_r4
