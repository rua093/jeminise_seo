...
BATCH_ID = "qa_batch_019_r2"
QA_RUN_ID = "20260907_213200"

SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "batches" / "SEO_Product_Optimization_through_batch_019.xlsx"
...
OUTPUT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_019_r2.xlsx"
REPORT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_019_r2.md"
...
PRODUCT_UPDATES = {
    181: {
        ...
        "meta_description": "Shop custom baseball glove bedding with brown glove artwork, baseballs, required name and number fields.",
        "primary": "custom baseball glove name bedding",
        "secondary": "baseball glove bedding, personalized baseball comforter, custom number baseball bedding",
        "cluster": "custom name number brown baseball glove bedding design 06",
    ...
    182: {
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by oversized ball on flag layout.",
    },
    183: {
        "title": "Custom Baseball Name Number Bedding",
        "meta_title": "Custom Baseball Name Number Bedding",
        "meta_description": "Shop custom baseball name number bedding with American flag background, baseball glove artwork and required fields.",
        "primary": "custom baseball name number bedding",
        "secondary": "baseball number bedding, American flag baseball bedding, personalized sports bedding",
        "cluster": "custom name number baseball flag glove bedding design 08",
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by large number on baseball layout.",
    },
    184: {
        "title": "Custom Close-Up Baseball Glove Bedding",
        "meta_title": "Custom Close-Up Baseball Glove Bedding",
        "meta_description": "Shop custom baseball glove bedding with close-up glove and ball artwork, required name and number fields.",
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by full-frame glove close-up.",
    },
    185: {
        "title": "Custom Gray Baseball Flag Bedding",
        "meta_title": "Custom Gray Baseball Flag Bedding",
        "meta_description": "Shop custom gray baseball flag bedding with glove and ball artwork, required name and number fields.",
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by gray glove over flag artwork.",
    },
    186: {
        "title": "Custom Baseball Pattern Name Bedding",
        "meta_title": "Custom Baseball Pattern Name Bedding",
        "meta_description": "Shop custom baseball pattern bedding with red white blue stripes, many baseballs, required name and number fields.",
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by repeated baseball pattern.",
    },
    187: {
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by pitcher silhouette artwork.",
    },
    188: {
        "title": "Custom Black Baseball Glove Bedding",
        "meta_title": "Custom Black Baseball Glove Bedding",
        "meta_description": "Shop custom black baseball glove bedding with ball artwork, required name and number fields, plus feature panels.",
        ...
        "cluster": "custom name number black baseball glove bedding design 13",
        "detail": "black baseball bedding with grayscale glove and ball artwork, sample cursive name and sample number",
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by black monochrome glove design.",
    },
    189: {
        ...
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by blue striped baseball layout.",
    },
    190: {
        "title": "Custom Galaxy Baseball Name Bedding",
        "meta_title": "Custom Galaxy Baseball Name Bedding",
        "meta_description": "Shop custom galaxy baseball bedding with blue space background, baseball artwork, required name and number fields.",
        "primary": "custom galaxy baseball name bedding",
        "secondary": "galaxy baseball bedding, baseball number comforter, personalized baseball bedding",
        "cluster": "custom name number galaxy baseball bedding design 15",
        "detail": "dark blue galaxy baseball bedding with space background, large baseball, sample cursive name and sample number",
        "intent_role": "Baseball bedding page supported by required name and number fields and separated by galaxy background artwork.",
    },
}
...
def description(pos, admin_row):
    ...
    return (
        ...
        "<li>Customizer audit captured required Customize Your Name and Customize Your Number fields.</li>"
...
def main():
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["issues"]).value = (
            f"R2 after Sang QA batch 019: used products_export_1.csv sha256:{admin_hash}; "
            "removed internal workflow copy, filled publishable title values, kept custom name/number claims only because customizer audit verifies them, "
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["jtbd_statement"]).value = (
            ...
            "and required name and number fields before purchase."
        )
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["verified_product_facts"]).value = (
            ...
            "custom_supported=true; customizer_note=required Customize Your Name and Customize Your Number fields captured"
        )
    ...
    for metric, value, definition in [
        ("qa_batch_019_r2_revision", "r2", "Separate 10-product revision after Sang QA; source workbook was not modified."),
        ("qa_batch_019_r2_admin_export", str(ADMIN_EXPORT.relative_to(ROOT)), f"Admin CSV baseline used; sha256:{admin_hash}."),
        ("qa_batch_019_r2_scope", "inventory positions 181-190", "No products outside qa_batch_019 were revised."),
        ("qa_batch_019_r2_revised_products", str(revised_products), "SEO_Products rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_019_r2_revised_images", str(revised_images), "Image_Audit rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_019_r2_admin_alt_matches", str(admin_alt_matches), "Image rows with current admin alt matched by image URL from Shopify CSV."),
    ]:
        ws.append([
