...
ROOT = m.ROOT
RUN_ID = '20260907_182000'
QA = ROOT / f'seo_runs/jeminise.com/20260906_234129/qa/{RUN_ID}'
WB = ROOT / 'resutls/jeminise.com/20260906_234129/batches/SEO_Product_Optimization_through_batch_013.xlsx'
...
def main():
    ...
    rows = list(csv.DictReader((ROOT / 'seo_runs/jeminise.com/20260906_234129/inventory.csv').open(encoding='utf-8-sig')))[120:130]
    ...
    print('batch13 sources collected: products =', len(sub['products']), ', images =', len(sub['images']))
