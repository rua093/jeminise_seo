...
RUN_ID, QA_RUN_ID = "20260906_234129", "20260907_095643"
exporter.DATA = ROOT / "seo_runs" / "jeminise.com" / RUN_ID / "qa" / QA_RUN_ID / "qa_workbook_payload.json"
exporter.OUTPUT = ROOT / "resutls" / "jeminise.com" / RUN_ID / "qa" / QA_RUN_ID / "SEO_QA_qa_batch_004.xlsx"
...
if __name__ == "__main__":
    ...
    assert audit["rows"] == {"QA_Summary":13,"QA_Products":10,"QA_Criteria":110,"QA_Images":62,"QA_Issues":34}
