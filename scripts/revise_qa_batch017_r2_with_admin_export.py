...
BATCH_ID = "qa_batch_017_r2"
QA_RUN_ID = "20260907_212312"

SOURCE = ROOT / "resutls" / SHOP / RUN_ID / "batches" / "SEO_Product_Optimization_through_batch_017.xlsx"
...
OUTPUT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_017_r2.xlsx"
REPORT = RESULT_DIR / "SEO_Product_Optimization_qa_batch_017_r2.md"
...
PRODUCT_UPDATES = {
    161: {
        ...
        "customizer": "The visible field is a general Customize Your Item text box; no name, number or file-submission field is claimed.",
    },
    162: {
    ...
    163: {
        ...
        "customizer": "The visible field is a general Customize Your Quilt text box; no name, number or file-submission field is claimed.",
    },
    164: {
        ...
        "customizer": "No verified personalization, name, number or file-submission field is claimed for this product.",
    },
    165: {
...
def main():
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["issues"]).value = (
            f"R2 after Sang QA batch 017: used products_export_1.csv sha256:{admin_hash}; "
            "removed internal workflow copy, filled publishable title values, avoided unsupported personalization and file-submission claims, "
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        ws.cell(row_num, idx["purchase_concerns"]).value = (
            "Avoid unsupported name, number, file-submission, cultural-origin or material claims; confirm exact size and product type."
        )
    ...
    for metric, value, definition in [
        ("qa_batch_017_r2_revision", "r2", "Separate 10-product revision after Sang QA; source workbook was not modified."),
        ("qa_batch_017_r2_admin_export", str(ADMIN_EXPORT.relative_to(ROOT)), f"Admin CSV baseline used; sha256:{admin_hash}."),
        ("qa_batch_017_r2_scope", "inventory positions 161-170", "No products outside qa_batch_017 were revised."),
        ("qa_batch_017_r2_revised_products", str(revised_products), "SEO_Products rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_017_r2_revised_images", str(revised_images), "Image_Audit rows revised and kept NEEDS_REVIEW."),
        ("qa_batch_017_r2_admin_alt_matches", str(admin_alt_matches), "Image rows with current admin alt matched by image URL from Shopify CSV."),
    ]:
        ws.append([
    ...
    REPORT.write_text(
        "\n".join(
            [
                ...
                "- Sửa trọng yếu: bỏ nội dung nội bộ, bổ sung title/H1 publishable, tránh claim custom hoặc file-submission không có bằng chứng, tách intent cho Norse/owl/Halloween theo motif nhìn thấy và viết lại mô tả/alt theo contact sheets.",
