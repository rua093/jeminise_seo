...
- Mốc title 50–60, meta 145–165, alt thường 125 ký tự là hướng dẫn biên tập; chỉ trừ điểm khi có lỗi cụ thể về rõ nghĩa, dài dòng, cắt ý hoặc giới hạn trường đã xác minh. Không trừ điểm máy móc vì title ngắn hơn 50 hoặc vì không nhắc brand.
- Meta description không bắt buộc đúng 155 ký tự. Không tự gán PARTIAL, lỗi MAJOR hoặc QA_REVISE chỉ vì ngoài khoảng 145–165; cũng không tự cho FULL vì nằm trong khoảng. Chấm D1 theo nội dung hiệu lực và bằng chứng. Câu bị cắt đứt từ/ý là lỗi nội dung cần chỉ rõ, dù dài đúng 155 ký tự. Đề xuất sửa phải là câu hoàn chỉnh; không dùng cắt chuỗi `[:155]`/`[:165]` để đạt mốc. Mốc biên tập không thay thế giới hạn kỹ thuật của trường đã xác minh.
